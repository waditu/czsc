...
def test_generate_signals_by_conf():
    ...
    for i, row in df.iterrows():
        ...
        bars.append(bar)
    signals_config = [{"freq1": "日线", "freq2": "日线", "name": "czsc.signals.cxt_zhong_shu_gong_zhen_V221221"}]
...
def test_signals_parser():
    ...
    conf = sp.parse(["日线_D1MO3_BE辅助V230222_新低_第2次_任意_0", "日线_60分钟_中枢共振V221221_看多_任意_任意_0"])
