...
from czsc.traders.base import CzscSignals,CzscTrader, check_signals_acc
...
def check():
    ...
    print(symbols)
    bars = research.get_raw_bars(symbols[0], '15分钟', '20230101', '20231231', fq='前复权')

    signals_config = [{'name': dkx_base_V240427, 'freq': "60分钟"}]
