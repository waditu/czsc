            ...
            'exits': [
                {
                    'operate': '平多',
                    'factors': [
                        {'name': '止盈', 'signals_all': [f'{_pos_name}_{freq1}YKB20N3_盈亏比判断V230624_多头达标_任意_任意_0']},
                        {'name': '止损', 'signals_all': [f'{_pos_name}_{freq1}YKB20N3_盈亏比判断V230624_多头止损_任意_任意_0']},
                    ],
                },
                {
                    'operate': '平空',
                    'factors': [
                        {'name': '止盈', 'signals_all': [f'{_pos_name}_{freq1}YKB20N3_盈亏比判断V230624_空头达标_任意_任意_0']},
                        {'name': '止损', 'signals_all': [f'{_pos_name}_{freq1}YKB20N3_盈亏比判断V230624_空头止损_任意_任意_0']},
                    ],
                },
            ],
            'interval': 7200,
