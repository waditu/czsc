    ...
    def create_pos(self, freq='60分钟', freq1='15分钟'):
        ...
        _pos = {'symbol': self.symbol,
                ...
                'exits': [
                    {'operate': '平多',
                     'factors': [
                         {'name': f'{freq1}_{_pos_name}_多头存疑',
                          'signals_all': [f'{_pos_name}_{freq1}N5M100_趋势判断V230414_多头存疑_任意_任意_0']},
                     ]},

                    {'operate': '平空',
                     'factors': [
                         {'name': f'{freq1}_{_pos_name}_空头存疑',
                          'signals_all': [f'{_pos_name}_{freq1}N5M100_趋势判断V230414_空头存疑_任意_任意_0']},
                     ]},
                ],
                'interval': 7200,
                'timeout': 100,
