...
class BiTable(FeishuApiBase):
    ...
    def table_field_list(
        self, table_id, page_size: int = 20, view_id=None, text_field_as_array=None, page_token=None
    ): ...
    ...
    def table_field_update(
        self, table_id, field_id, field_name, type, property=None, description=None, ui_type=None
    ): ...
