...
__all__ = [
    # 收益相关
    'show_daily_return', 'show_cumulative_returns', 'show_monthly_return',
    'show_drawdowns', 'show_rolling_daily_performance',
    
    # 相关性分析
    'show_correlation', 'show_sectional_ic', 'show_ts_rolling_corr',
    'show_ts_self_corr', 'show_cointegration', 'show_corr_graph', 'show_symbols_corr',
    
    # 因子分析
    'show_feature_returns', 'show_factor_layering', 'show_factor_value',
    'show_event_return', 'show_event_features',
    ...
    'show_outsample_by_dailys', 'show_psi', 'show_classify', 'show_date_effect',
    'show_normality_check', 'show_describe', 'show_df_describe',
