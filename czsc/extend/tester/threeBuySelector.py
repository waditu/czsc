...
def is_bc(symbol):
    ...
    factor_ = Factor(
        name="背驰选股",
        signals_any=[
            Signal("30分钟_倒3笔_三笔形态_向下盘背_任意_任意_0"),
            Signal("30分钟_倒5笔_基础形态_底背驰_任意_任意_0"),
            Signal("30分钟_倒7笔_基础形态_底背驰_任意_任意_0"),
            Signal("30分钟_倒9笔_类买卖点_类一买_任意_任意_0"),
            Signal("30分钟_倒11笔_类买卖点_类一买_任意_任意_0"),
            Signal("30分钟_倒11笔_类买卖点_类二买_任意_任意_0"),
