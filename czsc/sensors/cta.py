    ...
    def backtest(self, symbols, max_workers=3, **kwargs):
        ...
        if max_workers <= 1:
            ...
            with ProcessPoolExecutor(max_workers=max_workers) as executor:
                tasks = [
                    executor.submit(self._symbol_backtest, symbol, trader_path, bar_sdt, sdt, edt) for symbol in symbols
                ]
