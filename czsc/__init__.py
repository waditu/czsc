...
- ``czsc.{connectors,sensors,signals,traders,utils,svc,fsa,aphorism,mock,envs}``：Python 子包。
...
__all__ = [
    # 缠论核心
    "BI", "CZSC", "FX", "ZS", "BarGenerator", "Direction", "Event", "FakeBI",
    "Freq", "Mark", "NewBar", "Operate", "ParsedSignalDoc", "Position", "RawBar", "Signal",
    "boll_positions", "check_bi", "check_fx", "check_fxs",
    "ema", "format_standard_kline", "freq_end_time", "is_trading_time",
    "parse_signal_doc", "remove_include", "rolling_rank", "sma", "ultimate_smoother",
    # 来自 wbt
    "WeightBacktest", "daily_performance", "top_drawdowns",
    # 始终预加载的子包
    "connectors", "envs", "sensors", "signals", "traders", "utils",
    "svc", "fsa", "aphorism", "mock",
    # 交易器 / 信号 API
    "CzscSignals", "CzscTrader", "SignalsParser",
    "derive_signals_config", "derive_signals_freqs",
    "generate_czsc_signals", "get_signals_config", "get_signals_freqs", "get_unique_signals",
    # 策略门面
    "CzscStrategyBase", "CzscJsonStrategy",
    # 研究/优化入口
    "build_exit_optim_positions", "build_open_optim_positions",
    "run_optimize_batch", "run_replay", "run_research",
    # 通用工具
    "AliyunOSS", "DataClient", "DiskCache",
    "clear_cache", "clear_expired_cache",
    "code_namespace", "create_grid_params", "cross_sectional_ic",
    "dill_dump", "dill_load", "disk_cache",
    "empty_cache_path", "fernet_decrypt", "fernet_encrypt",
    "freqs_sorted", "generate_fernet_key",
    "get_dir_size", "get_py_namespace", "get_url_token",
    "holds_performance", "home_path",
    "import_by_name", "index_composition",
    "mac_address", "print_df_sample", "psi",
    "read_json", "resample_to_daily", "risk_free_returns",
    "rolling_daily_performance", "save_json", "set_url_token",
    "ta", "timeout_decorator", "to_arrow",
    "update_bbars", "update_nxb", "update_tbars", "x_round",
    # 静态 import 的高频符号（曾经走 _LAZY_ATTRS）
    "capture_warnings", "execute_with_warning_capture",
    "adjust_holding_weights", "log_strategy_info",
    "plot_czsc_chart", "KlineChart", "check_kline_quality",
    # EDA
    "remove_beta_effects", "vwap", "twap", "cross_sectional_strategy",
    "monotonicity", "min_max_limit", "rolling_layers", "cal_symbols_factor",
    "weights_simple_ensemble", "unify_weights",
    "sma_long_bear", "dif_long_bear", "tsf_type", "limit_leverage",
    "cal_trade_price", "mark_cta_periods", "mark_volatility", "cal_yearly_days",
    "turnover_rate", "make_price_features",
    # 元信息
    "__version__", "__author__", "__email__", "__date__", "welcome",
]
