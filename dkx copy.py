...
def dkx_base_V240427(c: CZSC, **kwargs) -> OrderedDict:
    ...
    **信号列表：**
    ...
    - Signal('30分钟_D1DKX#DEX_BS辅助V240427_空头_向上_任意_0')
    - Signal('30分钟_D1DKX#DEX_BS辅助V240427_空头_向下_任意_0')
    - Signal('30分钟_D1DKX#DEX_BS辅助V240427_多头_向上_任意_0')
    - Signal('30分钟_D1DKX#DEX_BS辅助V240427_多头_向下_任意_0')
...
def dkx_close_up_V240427(c: CZSC, **kwargs) -> OrderedDict:
    """DKX|DEX多空和方向信号
