    ...
    opens = [
        {
            ...
            "factors": [
                {
                    "signals_all": ["30分钟_D1DKX#DEX_BS辅助V240427_多头_向上_任意_0",
                                    "日线_D1DKX#DEX_BS辅助V240427_多头_向上_任意_0",
                                    "周线_D1DKX#DEX_BS辅助V240427_多头_向上_任意_0",
                                    "月线_D1DKX#DEX_BS辅助V240427_多头_向上_任意_0"],
                    "signals_any": [],
                    "signals_not": [],
                }
            ],
        },
        {
            ...
            "factors": [
                {
                    "signals_all": ["日线_D1CUPD#DEX_BS辅助V240427_卖点_任意_任意_0"],
                    "signals_any": [],
                    "signals_not": [],
                }
            ],
    ...
    opens = [
        {
            ...
            "factors": [
                {
                    "signals_all": ["30分钟_D1CUPD#DEX_BS辅助V240427_买点_任意_任意_0",
                                    "日线_D1DKX#DEX_BS辅助V240427_多头_向上_任意_0",
                                    "周线_D1DKX#DEX_BS辅助V240427_多头_向上_任意_0"],
                    "signals_any": [],
                    "signals_not": [],
        ...
        },
        {
            ...
            "factors": [
                {
                    "signals_all": ["30分钟_D1CUPD#DEX_BS辅助V240427_卖点_任意_任意_0"],
                    "signals_any": [],
                    "signals_not": ["日线_D1DKX#DEX_BS辅助V240427_多头_向上_任意_0",
                                    "日线_D1DKX#DEX_BS辅助V240427_空头_向上_任意_0"],
                }
            ],
        },
    ]
...
def backtest(stock):
    ...
    bars = list(tqdm(qn.get_raw_bars(stock, '30分钟', '20100101', '20240426', fq='不复权')))
    if not bars:
        logger.warning(f"No data for stock {stock}, skipping...")
        return
    trader = tactic.replay(bars, sdt='20100401', res_path=results_path / f"replay_{stock}", refresh=True)
...
class Strategy(czsc.CzscStrategyBase):
    ...
    def positions(self):
        pos_list = [
            ...
            trading_strategy_dkx_dir_V240428(self.symbol, base_freq='30分钟'),
...
if __name__ == '__main__':
    ...
    with open('d:/stock/sc/111.txt', 'r') as file:
        stock_list = []
